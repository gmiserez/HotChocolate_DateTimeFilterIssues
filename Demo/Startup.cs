            ...
            services.AddSingleton(sp =>
            {
                ...
                collection.InsertMany(new[]
                {
                    new City(
                        ...
                        "nl", 
                        true, 
                        new DateTime(2019,6,1,08,0,0,DateTimeKind.Utc)),
                    new City(
                        2, 
                        "Berlin", 
                        "de", 
                        true,
                        new DateTime(2019,7,10,08,0,0,DateTimeKind.Utc)),
                    new City(
                        3, 
                        "Paris", 
                        "fr", 
                        true,
                        new DateTime(2019,6,18,08,0,0,DateTimeKind.Utc)),
                    new City(
                        4, 
                        "Zürich", 
                        "ch", 
                        false,
                        new DateTime(2019,3,15,08,0,0,DateTimeKind.Utc)),
                });
